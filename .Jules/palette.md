...
## 2024-11-20 - Bridging Delight and Utility
**Learning:** "Delight" features like AI predictions lose value if users have to manually transcribe the results to use them.
**Action:** Always provide a direct action (e.g., "Jogar Agora") to automatically transfer generated data into the core user workflow.
