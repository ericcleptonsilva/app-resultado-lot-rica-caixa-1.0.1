...
## 2026-10-25 - Hiding Ligature-based Decorative Icons
**Learning:** Decorative font icons (like Google Material Icons) that use ligature text (e.g., 'auto_fix_high' or 'casino') are erroneously announced by screen readers, causing auditory clutter and confusing users.
**Action:** Always include `aria-hidden="true"` on the HTML element containing ligature-based icon text so that screen readers ignore it.
