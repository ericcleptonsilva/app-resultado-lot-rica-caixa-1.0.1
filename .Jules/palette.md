...
## 2026-04-15 - Accessible Loading States
**Learning:** Global spinners and async updating content areas lack screen reader announcements.
**Action:** Add `aria-live='polite'` and dynamic `aria-busy` states to loading containers to proactively announce dynamic state changes.
