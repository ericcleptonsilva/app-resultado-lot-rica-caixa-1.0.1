...
## 2026-10-25 - Hide Font Icon Ligatures
**Learning:** Decorative font icons (such as Google Material Icons) that use ligature text (e.g., 'auto_fix_high') are erroneously announced by screen readers, confusing users.
**Action:** Always include `aria-hidden="true"` on the icon container to prevent screen readers from reading the ligature text.
