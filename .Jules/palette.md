...
## 2026-05-17 - Accessible Icon Ligatures
**Learning:** Decorative font icons (such as Google Material Icons) that use ligature text (e.g., 'auto_fix_high') are erroneously announced to screen readers, causing confusion.
**Action:** Always include `aria-hidden="true"` on icon elements that use ligature text so that screen readers skip the internal text string.
