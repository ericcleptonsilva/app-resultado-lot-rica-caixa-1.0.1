...
## 2026-10-26 - Decorative Font Icons
**Learning:** Screen readers announce ligature text (e.g., 'auto_fix_high') if decorative font icons are not explicitly hidden, creating a confusing experience for visually impaired users.
**Action:** Always include `aria-hidden="true"` on decorative icon elements (like Material Icons) to prevent them from being announced by screen readers.
