...
## 2026-10-25 - Material Icon Ligatures
**Learning:** Decorative font icons (like Google Material Icons) that use ligature text (e.g., 'auto_fix_high') are mistakenly read aloud by screen readers, confusing users when announced alongside the actual button text.
**Action:** Always add `aria-hidden="true"` to ligature-based icon elements to prevent screen readers from erroneously announcing them.
