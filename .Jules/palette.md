...
## 2026-06-13 - Decorative Ligature Icons Accessibility
**Learning:** Decorative font icons using ligature text (like Material Icons' 'auto_fix_high') are often erroneously announced by screen readers, confusing users.
**Action:** Always add `aria-hidden="true"` to decorative ligature icons to hide them from assistive technologies, relying on visible text or visually hidden labels for meaning.
