...
**Learning:** "Delight" features like AI predictions are fun, but lose value if users have to manually memorize and copy the results to use them.
**Action:** Always bridge delight features directly to core utility workflows by providing immediate action buttons (e.g., "Jogar Agora") that automatically populate state and navigate the user.
