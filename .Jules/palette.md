...
## 2026-10-25 - Bridge Delight to Utility
**Learning:** Delight features (like AI predictions) are cool, but they lose their impact if they aren't tied back to the core utility of the app.
**Action:** Always bridge delight features back to the core workflow by providing direct action buttons (e.g., "Jogar Agora") that automatically populate forms and navigate users to the relevant task.
