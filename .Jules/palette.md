...
## 2026-10-25 - Hidden Ligatures
**Learning:** Font icons using ligature text (like Material Icons) are read aloud by screen readers (e.g., "auto fix high"), confusing visually impaired users.
**Action:** Always add `aria-hidden="true"` to decorative font icons to ensure screen readers ignore the ligature text.
