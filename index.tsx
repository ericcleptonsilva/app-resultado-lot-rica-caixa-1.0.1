        ...
        <div style={styles.card}>
          ...
          <div style={{display: "flex", gap: "10px", marginTop: "15px"}}>
             ...
             <button 
               ...
               title={selectedNumbers.length >= config.betLength ? `Você já selecionou ${config.betLength} números` : "Completar com números aleatórios"}
             >
             ...
             <button
               ...
               disabled={selectedNumbers.length >= config.betLength}
               aria-disabled={selectedNumbers.length >= config.betLength}
               title={selectedNumbers.length >= config.betLength ? `Você já selecionou ${config.betLength} números` : "Estratégia baseada em Gail Howard (Soma, Pares/Ímpares)"}
             >
             ...
             <button 
               ...
               disabled={selectedNumbers.length !== config.betLength}
               aria-disabled={selectedNumbers.length !== config.betLength}
               title={selectedNumbers.length !== config.betLength ? `Para ${config.name}, selecione exatamente ${config.betLength} números` : "Salvar jogo"}
             >
