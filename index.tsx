        ...
        <div style={styles.card}>
          ...
          <div style={{display: "flex", gap: "10px", marginTop: "15px"}}>
             ...
             <button 
               ...
               title={selectedNumbers.length >= config.betLength ? "Quantidade máxima atingida" : "Completar com números aleatórios"}
             >
             ...
             <button
               ...
               disabled={selectedNumbers.length >= config.betLength}
               aria-disabled={selectedNumbers.length >= config.betLength}
               title={selectedNumbers.length >= config.betLength ? "Quantidade máxima atingida" : "Estratégia baseada em Gail Howard"}
             >
