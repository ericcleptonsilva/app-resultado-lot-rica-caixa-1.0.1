        ...
        <div style={styles.card}>
          ...
          <div style={{display: "flex", gap: "10px", marginTop: "15px"}}>
             ...
             <button 
               ...
               title={selectedNumbers.length >= config.betLength ? "Quantidade máxima de números já selecionada" : undefined}
             >
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        ...
        {loading && (
          <div style={{textAlign: "center", padding: "40px"}} aria-live="polite" aria-busy={loading}>
            ...
            <div style={styles.aiBox}>
              ...
              {!aiPrediction ? (
                <button 
                  ...
                  title={aiLoading ? "Aguarde a IA gerar o palpite..." : undefined}
                >
        ...
        {!loading && activeTab === 'stats' && (
          <div role="tabpanel" id="panel-stats" aria-labelledby="tab-stats" tabIndex={0}>
            <div style={styles.card}>
              ...
              {loadingStats ? (
                <div style={{textAlign: "center", padding: "20px"}} aria-live="polite" aria-busy={loadingStats}>
