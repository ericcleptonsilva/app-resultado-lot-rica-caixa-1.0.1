    ...
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        ...
        {!loading && result && activeTab === 'results' && (
          <div role="tabpanel" id="panel-results" aria-labelledby="tab-results" tabIndex={0} aria-live="polite" aria-busy={loading}>
            <div style={styles.card}>
        ...
        {!loading && activeTab === 'games' && (
          <div role="tabpanel" id="panel-games" aria-labelledby="tab-games" tabIndex={0} aria-live="polite" aria-busy={loading}>
            {renderGamesTab()}
          </div>
        )}

        {!loading && activeTab === 'stats' && (
          <div role="tabpanel" id="panel-stats" aria-labelledby="tab-stats" tabIndex={0} aria-live="polite" aria-busy={loadingStats}>
            <div style={styles.card}>
              ...
              {loadingStats ? (
                <div aria-live="polite" aria-busy="true" style={{textAlign: "center", padding: "20px"}}>
