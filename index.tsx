        ...
        <div style={styles.card}>
          ...
          <div style={{display: "flex", gap: "10px", marginTop: "15px"}}>
             ...
             <button 
               ...
               title={selectedNumbers.length >= config.betLength ? "Jogo completo" : "Completar com números aleatórios"}
             >
             ...
             <button
               ...
               disabled={selectedNumbers.length >= config.betLength}
               aria-disabled={selectedNumbers.length >= config.betLength}
               title={selectedNumbers.length >= config.betLength ? "Jogo completo" : "Estratégia baseada em Gail Howard (Soma, Pares/Ímpares)"}
             >
             ...
             <button 
               ...
               disabled={selectedNumbers.length !== config.betLength}
               aria-disabled={selectedNumbers.length !== config.betLength}
               title={selectedNumbers.length !== config.betLength ? `Selecione ${config.betLength} números para salvar` : "Salvar jogo"}
             >
