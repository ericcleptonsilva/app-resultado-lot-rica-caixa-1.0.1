      ...
      <div style={styles.content}>
        ...
        {!loading && result && activeTab === 'results' && (
          <div role="tabpanel" id="panel-results" aria-labelledby="tab-results" tabIndex={0}>
            ...
            {/* IA Section */}
            <div style={styles.aiBox} aria-live="polite" aria-busy={aiLoading ? "true" : "false"}>
              ...
              {!aiPrediction ? (
                ...
                <div>
                  ...
                  <div style={{display: "flex", justifyContent: "center", gap: "10px", marginTop: "15px"}}>
                    <button
                      style={{
                        background: "white", border: "none", color: "#fda085",
                        padding: "5px 15px", borderRadius: "15px", cursor: "pointer", fontWeight: "bold"
                      }}
                      onClick={() => {
